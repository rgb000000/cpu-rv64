...
object Control {
  ...
  val map = Array(
    ...
    // I type
    jalr   -> List(PC_4, A_RS1,  B_IMM, IMM_I,   ALU_ADD,    BR_J,   N, ST_XXX, LD_XXX, WB_PC4, Y, CSR.N, N),
    ...
    // J type
    jal    -> List(PC_4, A_PC,   B_IMM, IMM_J,   ALU_ADD,    BR_J,   N, ST_XXX, LD_XXX, WB_PC4, Y, CSR.N, N),
